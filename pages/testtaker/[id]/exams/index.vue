                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-nowrap">Grade Result</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="exam in exams" :key="exam.id" class="intro-x">
                                    ...
                                    <td class="w-24">
                                        <div class="flex items-center justify-center" :class="{
                                            'text-success': exam.gradeResult !== 'UNAVAILABLE',
                                            'text-danger': exam.gradeResult === 'UNAVAILABLE',
                                        }">
                                        <div :class="{
                                            'hidden': exam.gradeResult !== 'UNAVAILABLE',
                                        }">

                                            <Icon name="ph:warning-circle" class="w-4 h-4 mr-1" ></Icon>
                                        </div>
                                            {{ exam.gradeResult === 'UNAVAILABLE' ? 
