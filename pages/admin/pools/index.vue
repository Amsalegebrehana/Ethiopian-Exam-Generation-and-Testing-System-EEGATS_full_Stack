            ...
            <Field name="addpoolInfoName" type="text" class="intro-x login__input form-control py-3 block"  
                                ...
                                <div class="flex items-center justify-center p-6 border-solid border-slate-200 rounded-b">
                                    ...
                                    <button @click="handleAddPool()"
                                        class="bg-primary rounded-xl w-5/12 text-white py-3 px-4 text-center" :disabled="isLoading || poolInfo.name.length < 2">
                                ...
                                <div
                                    ...
                                    <div class="relative p-6 flex-auto">
                                        ...
                                        <div class="flex flex-row items-center space-x-4 mx-auto">
                                            ...
                                            <p class=" font-bold text-lg text-center">Are you sure you want to delete pool "{{ poolInfo.name }}"</p>
                                        </div>
                                    </div>
                                    <!--footer-->
