                                            ...
                                            <div class="flex flex-row justify-between  space-x-6  items-center text-center">
                                                ...
                                                <div class="text-right align-middle ">
                                                    ...
                                                    <p class="text-3xl font-bold text-gray-800">{{
                                                        poolAnalytics.totalApprovedQuestions }}</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 justify-center">
                                            ...
                                            <div class="flex flex-row justify-between space-x-6  items-center text-center">
                                                ...
                                                <div class="text-right align-middle ">
                                                    ...
                                                    <p class="text-3xl font-bold text-gray-800">{{ poolAnalytics.examCount
                                                    }}</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 justify-center">
                                            ...
                                            <div class="flex flex-row justify-between   items-center text-center">
                                                ...
                                                <div class="text-right align-middle ">
                                                    ...
                                                    <p class="text-3xl font-bold text-gray-800">{{
                                                        poolAnalytics.contributorCount }}</p>
                                                </div>
                                            </div>
                            ...
                            <div class="align-middle items-center  my-auto h-full justify-center">
                                <div class="bg-white rounded-lg shadow-md p-6">
                                    ...
                                    <div class="space-y-4">
                                        <table class="w-full">
                                            ...
                                            <tbody>
                                                <tr v-for="(contributor, index) in poolAnalytics.topContributors"
                                                    :key="index">
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <div class="relative h-2 bg-gray-200 rounded">
                                                            <div class="absolute top-0 left-0 h-2 rounded"
                                                                ...
                                                                <div class="h-2 rounded"
                                                                    :class="{
                                                                        'bg-blue-500': poolAnalytics.topContributors.length > 0 && index === 0,
                                                        ...
                                                        <span class="text-gray-700">{{
                                                            contributor.contributionPercentage.toFixed(2)
                                                        }}%</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <div class="bg-white rounded-lg shadow-lg p-6 mt-4">
                                    ...
                                    <table class="mt-4 w-full">
                                        ...
                                        <tbody>
                                            <tr v-for="(category, index) in poolAnalytics.topCategories" :key="index"
                                                class="my-1">
                                ...
                                <div class="bg-white rounded-lg shadow-lg p-6 mt-5">
                                    ...
                                    <div class="mt-6">
                                        <Bar :data="poolAnalytics.catDistribution.data"
                                            :options="poolAnalytics.catDistribution.options" />
                                    </div>
                                </div>
