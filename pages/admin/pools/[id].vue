                                        ...
                                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                                            <div class="w-56 relative text-slate-500">
                                                <input type="text" class="form-control w-56 box pr-10"
                                                    placeholder="Search..." v-model="searchTextCat" />
                                    ...
                                    <div v-else class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                                                        ...
                                                        <td class="table-report__action w-56">
                                                            <div class="flex justify-center items-center">
                                                                <a class="flex items-center mr-6" href="javascript:;"
                                                                    ...
                                                                    <Icon name="eva:checkmark-square-outline"
                                                                        class="w-4 h-4 mr-1"></Icon> Edit
                                                                </a>
                                                                <a class="flex items-center text-danger" href="javascript:;"
                                                                    @click="DeleteCatModal(cateogry.id, cateogry.name)">
                                                                    <Icon name="fa6-regular:trash-can" class="w-4 h-4 mr-1">
                                                                    </Icon> Delete
                                                                </a>
                                                            </div>
                                                        </td>
                                        ...
                                        <div class="flex flex-row mt-3">
                                            <div class="md:block  text-slate-500">
                                                Showing {{ 1 + (catPage - 1) * 6 }} to {{ catPage * 6 < catCount! ? catPage
                                                    * 6 : catCount }} of {{ catCount! }} entries </div>
                                                    <div
                                        ...
                                        <div v-if="contributors?.length !== 0">
                                                        ...
                                                        <td class="table-report__action w-96">
                                                            <div class="flex justify-center items-center">
                                                                <a class="flex items-center mr-6 text-primary"
                                                                    href="javascript:;"
                                                                    @click="AssignModal(contributor.id, contributor.reviewsMade)">
                                                                ...
                                                                <a class="flex items-center text-danger" href="javascript:;"
                                                                    ...
                                                                    <Icon name="fluent-mdl2:cancel" class="w-4 h-4 mr-1">
                                                                    </Icon> Remove
                                                                </a>
                                                            </div>
                                                        </td>
                                            ...
                                            <div class="flex flex-row mt-3">
                                                <div class="md:block  text-slate-500">
                                                    ...
                                                    Showing {{ 1 + (page - 1) * 6 }} to {{ page * 6 < count! ? page * 6 :
                                                        count }} of {{ count! }} entries </div>
                                                        <div
                                                            class=" ml-auto intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
                                                            <nav class="w-full sm:w-auto sm:mr-auto">
                                                                <ul class="pagination">
                                ...
                                <div class="ml-12 ">
                                    <div v-if="categoriesNow" class="flex flex-row w-4/6 mt-3 ">
                                        ...
                                        <div class="flex flex-row rounded-md border ml-4">
                                            ...
                                            <DropDownSelect :optionslist="categoriesNow" v-model="catID"
                                                title="Choose Cateogry" id="cat" aria-required="true" class="" />
                                        </div>
                                    </div>
