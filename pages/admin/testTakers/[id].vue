            ...
            <div class="w-full mx-6">
                ...
                <div class="container mx-auto py-8">
                    <div v-if="testTakerResults">
                        <div class="flex flex-row justify-between mb-5 bg-gray-50 sticky  shadow-lg p-5 rounded-md ">
                            
                        <h1 class="text-2xl text-primary font-semibold mb-4 mx-10"> {{
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div v-for="result in testTakerResults.result" :key="result.id"
                                ...
                                <div class="flex ">
                                    ...
                                    <div class="flex flex-col items-start align-middle  w-4/12 my-auto mx-6">
                                        <h2 class="text-2xl font-semibold mb-5">{{ result.name }}</h2>
                                        <div class="flex flex-wrap mb-4 w-8/12">
                                        <div v-for="(count, category) in result.categories" :key="category"
                                            class="bg-gray-200 text-gray-600 rounded-full py-1 px-3 mr-2 mb-2">
                                            {{ category }}: {{ count }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-row space-x-10 mb-4 w-3/12 ">
