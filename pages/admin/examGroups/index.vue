...
<template>
    <div>
        ...
        <div class="flex" :class="{ 'fixed w-full': showAddModal || showEditModal || showDeleteModal }">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-row sm:flex-nowrap items-center mt-2 ">
                        <button v-on:click="toggleAddModal()" class="btn btn-primary shadow-md mr-auto"
                            data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">Create Exam
                            Group
                                        ...
                                        <td class="table-report__action w-96">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-6 text-primary"
                                                    :href="`/admin/examGroups/${exgrp.id}`">
                                                    <Icon name="tabler:device-analytics" class="w-4 h-4 mr-1"></Icon> View
                                                    Details
                                                </a>
                                                <button class="text-success flex items-center mr-6"
                                                    @click="EditModal(exgrp.id, exgrp.name)">
                                                    <Icon name="material-symbols:edit-outline" class="w-4 h-4 mr-1"> </Icon>
                                                    Edit
                                                </button>

                                                <button class="flex items-center "
                                                    :class="exgrp._count['Exam'] !== 0 ? ' text-white' : 'text-danger'"
                                                    :disabled="exgrp._count['Exam'] !== 0"
                                                    @click="DeleteModal(exgrp.id, exgrp.name)">
            ...
            <div
                ...
                <div class="relative p-6 flex-auto">
                    ...
                    <div class="flex flex-row align-middle mt-2">
                        ...
                        <Form class="w-full">
                            ...
                            <Field name="addExamGroupInfoName" type="text"
                ...
                <div class="flex items-center justify-center p-6 border-solid border-slate-200 rounded-b">
                    ...
                    <button @click="handleAddExamGroup()"
                        ...
                        :disabled="isLoading || examGroupInfo.name.length < 2">
                ...
                <div class="relative p-6 flex-auto">
                    <div class="flex flex-row align-middle">
                        ...
                        <Form class="w-full">
                            ...
                            <Field name="editExamGroupInfoName" type="text"
                                class="intro-x login__input form-control py-3 block"
                                placeholder="Enter Pool Name" v-model="examGroupInfo.name"
                                :rules="fieldSchema" />
                        </Form>
            ...
            <div
                ...
                <div class="relative p-6 flex-auto">
                    ...
                    <div class="flex flex-row items-center space-x-4 mx-auto">
                        ...
                        <p class=" font-bold text-lg text-center">Are you sure you want to delete exam group "{{
                            examGroupInfo.name }}"</p>
                    </div>
                </div>
                <!--footer-->
                <div
