...
const changePassword = async () => {
    try {
        alreadyExists.value = false;
        const data = await $client.passwordHandlerRouter.changePassword.mutate({ id: '', oldPassword: userInfo.value.oldPassword, newPassword: userInfo.value.newPassword });
